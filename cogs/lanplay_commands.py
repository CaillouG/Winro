...
class LanPlay(commands.Cog):
    ...
    async def pack(self, ctx): 
        ...
        embed.set_author(name='Pack LanPlay', icon_url="https://winro-bot.000webhostapp.com/ressources/site.png")
    ...
    async def site(self, ctx):
        ...
        embed.set_author(name='Site LanPlay FR', icon_url="https://winro-bot.000webhostapp.com/ressources/site.png")
    ...
    async def serveur(self, ctx):
        ...
        embed.set_author(name='Serveur Discord LanPlay FR :', icon_url="https://winro-bot.000webhostapp.com/ressources/site.png")
