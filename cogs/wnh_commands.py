    ...
    async def island(self, ctx, arg1=None):
        ...
        if arg1 == None :
            if os.path.isdir(f"./cogs/games/wnh/{ctx.author.id}") == False :
                ...
                embed.set_author(name="Winro New Horizons :", icon_url="https://winro-bot.000webhostapp.com/ressources/winro.png")
                ...
                embed.set_author(name="Votre île :", icon_url="https://winro-bot.000webhostapp.com/ressources/winro.png")
                if "1" in islandtype:
